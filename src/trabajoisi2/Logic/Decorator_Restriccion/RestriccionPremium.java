...
import trabajoisi2.personas.suscriptores.SuscriptorUniversal;
...
public class RestriccionPremium extends SuscriptionDecorator {
    ...
    public boolean verPelicula(Pelicula pPelicula) {
        if(EsAccesible(pPelicula)){
            ...
            System.out.println("¡Acceso restringido para usuarios Premium!");
            return false;
        }
    }
    ...
    private boolean EsAccesible(IContenido contenido) {
        ...
        if((aux instanceof SuscriptorUniversal)){
            return false;
        }
        return true;
    }
